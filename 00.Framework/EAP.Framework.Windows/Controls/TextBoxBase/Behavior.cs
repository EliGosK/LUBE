...
namespace EAP.Framework.Windows.Controls {
    ...
    public abstract class Behavior : IDisposable {
        ...
        protected System.Windows.Forms.TextBoxBase m_textBox;
        ...
        protected Behavior(System.Windows.Forms.TextBoxBase textBox, bool addEventHandlers) {
            if (textBox == null)
        ...
        public virtual void ShowErrorMessageBox(string message) {
            MessageDialog.ShowBusinessErrorMsg(m_textBox, message);
        }
    ...
    public class AlphanumericBehavior : Behavior {
        ...
        public AlphanumericBehavior(System.Windows.Forms.TextBoxBase textBox)
            :
            base(textBox, true) {
        }
        ...
        /// <exception cref="ArgumentNullException">textBox is null. </exception>
        public AlphanumericBehavior(System.Windows.Forms.TextBoxBase textBox, char[] invalidChars)
            :
            base(textBox, true) {
        ...
        /// <exception cref="ArgumentNullException">textBox is null. </exception>
        public AlphanumericBehavior(System.Windows.Forms.TextBoxBase textBox, string invalidChars)
            :
            base(textBox, true) {
    ...
    public class MaskedBehavior : Behavior {
        ...
        /// <seealso cref="Mask" />
        public MaskedBehavior(System.Windows.Forms.TextBoxBase textBox)
            :
            this(textBox, "") {
        }
        ...
        public MaskedBehavior(System.Windows.Forms.TextBoxBase textBox, string mask)
            :
            base(textBox, true) {
            m_mask = mask;
    ...
    public class NumericBehavior : Behavior {
        ...
        public NumericBehavior(System.Windows.Forms.TextBoxBase textBox)
            :
            base(textBox, true) {
        ...
        public NumericBehavior(System.Windows.Forms.TextBoxBase textBox, int maxWholeDigits, int maxDecimalPlaces)
            :
            this(textBox) {
        ...
        /// <seealso cref="Mask" />
        public NumericBehavior(System.Windows.Forms.TextBoxBase textBox, string mask)
            :
            base(textBox, true) {
            Mask = mask;
        }
        ...
        protected override void HandleKeyPress(object sender, KeyPressEventArgs e) {
            ...
            /** debug by Mr.Fuangwith Sopharath @ 01/06/2006 **/
            if (m_textBox.SelectionLength > 0) {
                String sTemp = text.Substring(m_textBox.SelectionStart, m_textBox.SelectionLength);
                text = text.Replace(sTemp, c.ToString());
                numericText = text;
            }
    ...
    public class IntegerBehavior : NumericBehavior {
        ...
        public IntegerBehavior(System.Windows.Forms.TextBoxBase textBox)
            :
            base(textBox, 9, 0) {
        }
        ...
        ///   and the rest of the properties according to user's system. </remarks>
        public IntegerBehavior(System.Windows.Forms.TextBoxBase textBox, int maxWholeDigits)
            :
    ...
    public class CurrencyBehavior : NumericBehavior {
        ...
        ///   loses focus. </remarks>
        public CurrencyBehavior(System.Windows.Forms.TextBoxBase textBox)
            :
            base(textBox) {
            m_flags |= ((int)LostFocusFlag.RemoveExtraLeadingZeros | (int)LostFocusFlag.PadWithZerosAfterDecimal | (int)LostFocusFlag.DontPadWithZerosIfEmpty);
    ...
    public class DateBehavior : Behavior {
        // Fields
        private DateTime m_rangeMin = DateTimePicker.MinDateTime;
        private DateTime m_rangeMax = DateTimePicker.MaxDateTime;
        ...
        /// <seealso cref="System.Windows.Forms.TextBoxBase" />	
        public DateBehavior(System.Windows.Forms.TextBoxBase textBox)
            :
            this(textBox, true) {
        }
        ...
        /// <seealso cref="System.Windows.Forms.TextBoxBase" />	
        internal DateBehavior(System.Windows.Forms.TextBoxBase textBox, bool addEventHandlers)
            :
    ...
    public class TimeBehavior : Behavior {
        ...
        /// <seealso cref="System.Windows.Forms.TextBoxBase" />	
        public TimeBehavior(System.Windows.Forms.TextBoxBase textBox)
            :
            base(textBox, true) {
        ...
        public int Minute {
            get {
                ...
                int startPos = GetMinuteStartPosition();
                if (text.Length >= startPos + 2)
                    return ToInt(text.Substring(startPos, 2));
        ...
        public int Second {
            get {
                ...
                int startPos = GetSecondStartPosition();
    ...
    public class DateTimeBehavior : TimeBehavior {
        ...
        /// <seealso cref="System.Windows.Forms.TextBoxBase" />	
        public DateTimeBehavior(System.Windows.Forms.TextBoxBase textBox)
            :
            base(textBox) {
