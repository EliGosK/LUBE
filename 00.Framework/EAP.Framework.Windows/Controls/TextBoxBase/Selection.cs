...
namespace EAP.Framework.Windows.Controls
{
    ...
    public class Selection {
        // Fields
        private System.Windows.Forms.TextBoxBase m_textBox;
        ...
        public Selection(System.Windows.Forms.TextBoxBase textBox) {
            m_textBox = textBox;
        }
        ...
        /// <seealso cref="System.Windows.Forms.TextBoxBase" />	
        public Selection(System.Windows.Forms.TextBoxBase textBox, int start, int end) {
            m_textBox = textBox;
            Set(start, end);
        }
        ...
        public void Set(int start, int end) {
            ...
            /** something when behavior.dispose() start and end value less than 0 **/
            if (start >= 0) m_textBox.SelectionStart = start;
            if (end - start >= 0) m_textBox.SelectionLength = end - start;
        }
        ...
        public class Saver : IDisposable {
            ...
            /// <seealso cref="System.Windows.Forms.TextBoxBase" />	
            public Saver(System.Windows.Forms.TextBoxBase textBox) {
                m_textBox = textBox;
